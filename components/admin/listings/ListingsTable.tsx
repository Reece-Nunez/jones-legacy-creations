...
import { Pencil, Trash2, ExternalLink, Plus, Home } from "lucide-react";
            ...
            <div className="flex-1 p-4 sm:p-5 flex flex-col gap-2">
              ...
              {l.mls_url && (
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs font-medium text-indigo-600 hover:text-indigo-800 self-start"
                >
              ...
              <div className="mt-2 flex items-center gap-2 pt-2 border-t border-gray-100">
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 min-h-[40px] text-sm font-medium text-gray-700 hover:bg-gray-100"
                >
