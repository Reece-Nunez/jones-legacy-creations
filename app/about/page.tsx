...
export default function AboutPage() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section aria-label="About us hero" className="pt-32 pb-12 bg-gradient-to-br from-gray-50 to-white">
      ...
      {/* Story & Photo Section */}
      <section aria-label="Our story" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section aria-label="Why choose us" className="py-20 bg-gradient-to-b from-gray-50 to-white">
